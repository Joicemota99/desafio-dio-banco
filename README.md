# Desafio: Criação de banco digital.
...
# 👣 Passo-a-Passo
1. Utilizando o método de Abstração.
2. Utilizando o método de Encapsulamento.
3. Utilizando o método de Herança.
4. Utilizando o método de Interface. 
5. Utilizando o método de Polimorfismo.
